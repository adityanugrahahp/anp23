...
public class HomePage extends PageObject {
    ...
    private By beliButton() {
        return By.xpath(
                "//div[@id='13550']//button[@class='button-beli ml-3 v-btn v-btn--outlined theme--light v-size--small primary--text']");
    }

    private By detailButton() {
        return By.xpath(
                "//div[@id='13550']//button[@class='button-beli v-btn v-btn--outlined theme--light v-size--small primary--text']");
    }
