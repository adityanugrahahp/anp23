...
public class LoginSteps {
    ...
    //As a user I want to login with valid account
    ...
    //As a user I want to login with wrong password
    ...
    //As a user I want to login with wrong email

    @And("I input incorrect email in login")
    public void iInputIncorrectEmailInLogin() {
        String email = "aditz" + "@mail.com";
        loginScreen.inputFieldEmail(email);
    }

    //As a user I want to login with invalid email

    @And("I input invalid email in login")
    public void iInputInvalidEmailInLogin() {
        String email = "adit123";
        loginScreen.inputFieldEmail(email);
    }

    //As a user I want to login without input any fields
