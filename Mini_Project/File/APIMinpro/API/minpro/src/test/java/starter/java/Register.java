...
public class Register {
    ...
    public void sendPostHttpRequestRegister() {
        ...
        // GANTI SETIAP RUN
        requestBody.put("email", "adityaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@gmail.com");
    ...
    public void sendPostHttpRequestRegister6() {
        JSONObject requestBody = new JSONObject();
        requestBody.put("email", "aditaaagmail.com");
        requestBody.put("password", "adit123");
        requestBody.put("fullname", "adit");
    ...
    public void sendPostHttpRequestRegister7() {
        JSONObject requestBody = new JSONObject();
        requestBody.put("email", "aditbaa@gmail.com");
        requestBody.put("password", " ");
        requestBody.put("fullname", "adit");
    ...
    public void sendPostHttpRequestRegister8() {
        JSONObject requestBody = new JSONObject();
        requestBody.put("email", "aditcaa@gmail.com");
        requestBody.put("password", "adit123");
        requestBody.put("fullname", "1213");
